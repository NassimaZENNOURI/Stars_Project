...
public class StarAdapter extends RecyclerView.Adapter<StarAdapter.StarViewHolder> implements Filterable {
    ...
    private List<Stars> stars; // List complète des étoiles
    private List<Stars> starsFiltered; // Liste filtrée
    private final Context context;

    public StarAdapter(Context context, List<Stars> stars) {
        this.stars = stars;
        this.starsFiltered = new ArrayList<>(stars); // Initialiser avec la liste complète
                ...
                AlertDialog dialog = new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Valider", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Stars star = StarService.getInstance().findById(ids);
                                star.setStar(s);
    ...
    public void onBindViewHolder(@NonNull StarViewHolder starViewHolder, int i) {
        ...
        Stars star = starsFiltered.get(i);
        Glide.with(context)
                .asBitmap()
                .load(star.getImg())
    ...
    private class NewFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            List<Stars> filteredList = new ArrayList<>();
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            starsFiltered.clear();
            starsFiltered.addAll((List<Stars>) filterResults.values);
